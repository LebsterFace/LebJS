...
public record FunctionDeclaration(BlockStatement body, String name, xyz.lebster.core.node.FunctionArguments arguments) implements FunctionNode, Declaration {
	@Override
