...
Test.expect(false, 1 >= 2);
Test.expect(true, 2 >= 1);
...
Test.expect(true, 1 >= 0.01);
Test.expect(false, 0.01 >= 1);
Test.expect(true, 1 >= 0.0001);
Test.expect(false, 0.0001 >= 1);
Test.expect(false, 1 >= Math.PI);
Test.expect(true, Math.PI >= 1);
Test.expect(true, 1 >= 0);
Test.expect(false, 0 >= 1);
Test.expect(true, 1 >= -0);
Test.expect(false, -0 >= 1);
Test.expect(true, 2 >= 2);
...
Test.expect(true, 2 >= 0.01);
Test.expect(false, 0.01 >= 2);
Test.expect(true, 2 >= 0.0001);
Test.expect(false, 0.0001 >= 2);
Test.expect(false, 2 >= Math.PI);
Test.expect(true, Math.PI >= 2);
Test.expect(true, 2 >= 0);
Test.expect(false, 0 >= 2);
Test.expect(true, 2 >= -0);
Test.expect(false, -0 >= 2);
...
Test.expect(false, NaN >= -0);
Test.expect(false, -0 >= NaN);
Test.expect(true, 0.01 >= 0.01);
Test.expect(true, 0.01 >= 0.0001);
Test.expect(false, 0.0001 >= 0.01);
Test.expect(false, 0.01 >= Math.PI);
Test.expect(true, Math.PI >= 0.01);
Test.expect(true, 0.01 >= 0);
Test.expect(false, 0 >= 0.01);
Test.expect(true, 0.01 >= -0);
Test.expect(false, -0 >= 0.01);
Test.expect(true, 0.0001 >= 0.0001);
Test.expect(false, 0.0001 >= Math.PI);
Test.expect(true, Math.PI >= 0.0001);
Test.expect(true, 0.0001 >= 0);
Test.expect(false, 0 >= 0.0001);
Test.expect(true, 0.0001 >= -0);
Test.expect(false, -0 >= 0.0001);
Test.expect(true, Math.PI >= Math.PI);
Test.expect(true, Math.PI >= 0);
Test.expect(false, 0 >= Math.PI);
Test.expect(true, Math.PI >= -0);
Test.expect(false, -0 >= Math.PI);
Test.expect(true, 0 >= 0);
Test.expect(true, 0 >= -0);
Test.expect(true, -0 >= 0);
Test.expect(true, -0 >= -0);